...
const faUiPhrases: Array<[RegExp, string]> = [
  ...
  [/Subscription Management/g, 'مدیریت اشتراک‌ها'],
  [/Total Subscriptions/g, 'کل اشتراک‌ها'],
  [/Active Subscriptions/g, 'اشتراک‌های فعال'],
  [/All Subscriptions/g, 'همه اشتراک‌ها'],
  [/No subscriptions found\./g, 'اشتراکی پیدا نشد.'],
  [/Total Revenue/g, 'کل درآمد'],
  [/Average Value/g, 'میانگین ارزش'],
  [/Unknown user/g, 'کاربر ناشناس'],
  [/Unknown plan/g, 'پلن نامشخص'],
  [/Start Date/g, 'تاریخ شروع'],
  [/End Date/g, 'تاریخ پایان'],
  [/Actions/g, 'عملیات'],
  [/Cancelled/g, 'لغوشده'],
  [/Expired/g, 'منقضی‌شده'],
  [/Active/g, 'فعال'],
  [/Back/g, 'بازگشت'],
  [/View/g, 'مشاهده'],
  [/Save Changes/g, 'ذخیره تغییرات'],
  [/Delete/g, 'حذف'],
  [/Create User/g, 'ایجاد کاربر'],
  [/Loading analysis details\.\.\./g, 'در حال بارگذاری جزئیات تحلیل...'],
  [/Page Not Found/g, 'صفحه پیدا نشد'],
  [/No Analysis Available/g, 'تحلیلی موجود نیست'],
  [/Premium Content/g, 'محتوای ویژه'],
];
